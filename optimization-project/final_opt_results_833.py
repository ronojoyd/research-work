...
data2 = [74.39580315999999, 75.53723567, 74.26471412999997, 73.52847055, 73.19971168000002, 71.61659806, 68.90512800000002, 67.96641059999999, 67.35142396, 63.01869877399999]
data1 = [136, 129, 112, 99, 88, 75, 62, 53, 47, 37]

fig, ax1 = plt.subplots()

color = 'tab:red'
ax1.set_xlabel('Duration', fontsize=14)
#ax1.set_ylabel('Sum of Vaccines', color='red', fontsize=14)
ax1.set_ylabel('Susceptible Population', color='red', fontsize=14)
ax1.plot([i*5 for i in range(len(data2))], data1, color='red')
ax1.tick_params(axis='y', labelcolor='red')

ax2 = ax1.twinx()  # instantiate a second axes that shares the same x-axis

color = 'tab:blue'
ax2.set_ylabel('Sum of Vaccines', color='blue', fontsize=14) # we already handled the x-label with ax1
ax2.plot([i*5 for i in range(len(data2))], data2, color='blue')
